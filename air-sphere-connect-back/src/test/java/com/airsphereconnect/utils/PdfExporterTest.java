...
class PdfExporterTest {
    ...
    void exportToPdf_combined_shouldGeneratePdf() {
    ...
    void exportToPdf_weather_shouldGeneratePdf() {
    ...
    void exportToPdf_airQuality_shouldGeneratePdf() {
    ...
    void exportToPdf_shouldHandleEmptyData() {
