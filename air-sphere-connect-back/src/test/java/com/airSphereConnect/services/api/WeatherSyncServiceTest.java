...
class WeatherSyncServiceTest {
    ...
    class SyncDataTests {
        ...
        void syncData_shouldIncrementErrorsOnFailure() {
            when(cityRepository.findAll()).thenThrow(new RuntimeException("Database error"));
    ...
    class FetchAndStoreTests {
        ...
        void shouldHandleWeatherWithAlerts() throws Exception {
            ...
            WeatherMainDto mainDto = new WeatherMainDto(25.0, 60.0, 1013.0);
            WeatherAlertDto[] alerts = new WeatherAlertDto[]{
                    new WeatherAlertDto("NWS", "Storm", "description")
            };
        ...
        void shouldHandleWeatherDescription() throws Exception {
            ...
            WeatherMainDto mainDto = new WeatherMainDto(25.0, 60.0, 1013.0);
            WeatherDescriptionDto[] descriptions = new WeatherDescriptionDto[]{
                    new WeatherDescriptionDto("Clear", "clear sky", "01d")
            };
