...
public class AuthService {
     ...
     */
    @NotNull
    private ResponseEntity<Object> getGuestResponse(HttpServletResponse response) {
     ...
     */
    public ResponseEntity<Object> signupAndLogin(UserRequestDto dto, HttpServletResponse response) {
     ...
     */
    public ResponseEntity<Object> editUserLogin(UserRequestDto reqDto, User currentUser,
     ...
     */
    public ResponseEntity<Object> login(LoginRequestDto loginDto, HttpServletResponse response) {
        try {
     ...
     */
    public ResponseEntity<Object> getUserProfile(HttpServletRequest request, HttpServletResponse response) {
     ...
     */
    public ResponseEntity<Object> deleteUser(Long id, HttpServletRequest request, HttpServletResponse response) {
        Optional<String> jwtOpt = extractJwtFromRequest(request);
